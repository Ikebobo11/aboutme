...
import Face from '../assets/resized-face.jpeg'
            ...
            <section className="artifacts-container">
                ...
                <div className="artifacts-grid">
                    ...
                    <div className="card-content">
                        ...
                        <span className="artifact-tag">HTML</span>
                        <span className="artifact-tag">CSS</span>
                        <span className="artifact-tag">JavaScript</span>
                        </div>
                        <h3 className="card-title">Facebook Clone</h3>
